...
export class NewsService {
  ...
  public getNews(): NewsItem[] {
    return [
      {
        id: 1,
        image: '/static/assets/images/news_preview_temp_1.jpg',
      ...
      {
        id: 2,
        image: '/static/assets/images/news_preview_temp_2.jpg',
      ...
      {
        id: 3,
        image: '/static/assets/images/news_preview_temp_3.jpg',
      ...
      {
        id: 4,
        image: '/static/assets/images/news_preview_temp_4.jpg',
      ...
      {
        id: 5,
        image: '/static/assets/images/news_preview_temp_5.jpg',
  ...
  public getPictures(): Picture[] {
    return [
      {
        url: '/static/assets/images/picture_preview_temp_1.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_2.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_3.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_4.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_5.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_6.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_7.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_8.jpg',
      ...
      {
        url: '/static/assets/images/picture_preview_temp_9.jpg',
    ...
    return [
      {
        ...
        title: 'Away Trips',
        cover: '/static/assets/images/picture_preview_temp_1.jpg'
      },
      {
        id: 2,
        url: 'http://www.localhost.com/data/album_2',
        title: 'Random',
        cover: '/static/assets/images/picture_preview_temp_5.jpg'
      },
      {
        id: 3,
        url: 'http://www.localhost.com/data/album_3',
        title: 'Regattas',
        cover: '/static/assets/images/picture_preview_temp_3.jpg'
      }
    ]
  }
  ...
  public getRoster(): Profile[] {
    return [
      {
        name: 'Matt C',
        image: '/static/assets/images/matthew_carroll.jpg',
        start_year: 2002,
        end_year: null,
        strength: 'MATLAB',
      ...
      {
        name: 'Sara C',
        image: '/static/assets/images/sara_carroll.jpg',
        start_year: 2002,
        end_year: null,
      ...
      {
        name: 'Matt R',
        image: '/static/assets/images/matt_rayan.jpg',
        start_year: 2015,
        end_year: null,
      ...
      {
        name: 'Brian Lee',
        image: '/static/assets/images/brian_lee.jpg',
        start_year: 2014,
        end_year: null,
        strength: 'DDR',
      ...
      {
        name: 'Enoch Wong',
        image: '/static/assets/images/enoch_wong.jpg',
        start_year: 2015,
        end_year: null,
        strength: 'Stretching',
        weakness: 'Shirts',
      ...
      {
        name: 'Jon Yeung',
        image: '/static/assets/images/jon_yeung.jpg',
        start_year: 2014,
        end_year: null,
  ...
  public getAlumni(): Profile[] {
    return [
      {
        name: 'Hamilton L',
        image: '/static/assets/images/hamilton_liao.jpg',
        start_year: 2002,
        end_year: 2010,
      ...
      {
        name: 'Alfred P',
        image: '/static/assets/images/alfred_poon.jpg',
        start_year: 2002,
        end_year: 2010,
        strength: 'Going buck',
      ...
      {
        name: 'Steve X',
        image: '/static/assets/images/steve_xu.jpg',
        start_year: 2006,
        end_year: 2010,
      ...
      {
        name: 'Mike B',
        image: '/static/assets/images/mike_b.jpg',
        start_year: 2006,
        end_year: 2011,
        strength: 'Muay Thai',
      ...
      {
        name: 'Peter F',
        image: '/static/assets/images/peter_f.jpg',
        start_year: 2005,
        end_year: 2011,
      ...
      {
        name: 'Shannon W',
        image: '/static/assets/images/shannon_w.jpg',
        start_year: 2007,
        end_year: 2011,
        strength: 'Pushups',
